package www.ensch.json.activity;
...
import www.ensch.json.adapter.AdapterActivity;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://pruebaganagana.esy.es/jsonp.txt");
        ...
        protected void onPostExecute(String result) {
            ...
            pdLoading.dismiss();
            List<DataActivity> data=new ArrayList<>();
            ...
            try {
                ...
                JSONArray jArray = jsonRootObject.optJSONArray("pruebas");
